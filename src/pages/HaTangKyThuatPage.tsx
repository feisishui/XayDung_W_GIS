...
// Component
import MapComponent from '../components/HaTangKyThuat/MapComponent';
import ToolComponent from '../components/HaTangKyThuat/ToolComponent';

import LayerInfo from '../services/map/models/LayerInfo';
import layerHelper from '../map-lib/support/LayerHelper';
...
class XemDuLieuPage extends BasePage<Props, States> {
  ...
  private initFL(layerInfos: LayerInfo[]) {
    try {
      const layers =  layerHelper.assignLayer(layerInfos, this.props.id);
