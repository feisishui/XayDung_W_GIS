...
import MapComponent from '../components/PhanAnhSaiPhamXayDung/MapComponent';
import FormComponent from '../components/PhanAnhSaiPhamXayDung/FormComponent';
...
import { phanAnhSuCo, setLayer } from '../services/map/SuCo/suco.action';
    ...
    try {
      ...
      if (this.props.view) {
        ...
        // set sự cố
        {
          ...
          layerSuCo.definitionExpression = `LinhVuc = ${LinhVuc.SaiPhamXayDung}`;
     ...
     this.props.alertError(error&& error.message);
    }
  }
