...
import MovingGeometryViewModel from './MovingGeometryViewModel';
...
class PopupEditing {
  ...
  private _movingGeometryViewModel:MovingGeometryViewModel|undefined;
  
  public get movingGeometryViewModel() : MovingGeometryViewModel {
    if(!this._movingGeometryViewModel){
      this._movingGeometryViewModel = new MovingGeometryViewModel({view:this.view});
    }
    return this._movingGeometryViewModel;
  }
  ...
  /**
   * Thay đổi vị trí đối tượng selectedFeature
   */
  public async moveGeometry(){
    this.movingGeometryViewModel.move(this.view.popup.selectedFeature);
  }
}
