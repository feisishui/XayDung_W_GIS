...
import DownloadCSVComponent from '../../components/material-ui/DownLoadCSV';
import SketchSearch from './InputItem/SketchSearch';
import SketchSearchViewModel from './SketchSearchViewModel';
// ESRI
...
import PhuongXaInputItem from './InputItem/PhuongXaInputItem';
import QuanHuyenInputItem from './InputItem/QuanHuyenInputItem';
...
class SearchComponent extends React.PureComponent<Props, States> {
  ...
  private async onChangeSelectedFeature(event: React.ChangeEvent<HTMLSelectElement>) {
    try {
  ...
  private renderForm() {
    ...
    const getItemComponent = (layerField: __esri.Field) => {
      switch (layerField.name) {
        case BASEMAP.MaHuyenTP:
          return <QuanHuyenInputItem
            layerField={layerField}
            value={searchFields[layerField.name]}
            onChange={this.onChange.bind(this)}
          />
        case BASEMAP.MaPhuongXa:
          let maHuyenTP = searchFields[BASEMAP.MaHuyenTP];
          return <PhuongXaInputItem
            maHuyenTP={maHuyenTP}
            layerField={layerField}
            value={searchFields[layerField.name]}
            onChange={this.onChange.bind(this)}
          />
        case BASEMAP.MaDuong:
          return <GiaoThongInputItem
            layerField={layerField}
            value={searchFields[layerField.name]}
            onChange={this.onChange.bind(this)}
          />
