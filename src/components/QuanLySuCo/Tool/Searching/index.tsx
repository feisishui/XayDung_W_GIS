...
//Redux
import { timKiem } from '../../../../services/map/SuCo/suco.action';
import { alertActions } from '../../../../services/main/main.action';
import { connect } from 'react-redux';

//Esri
import FeatureLayer from '../../../../map-lib/layers/FeatureLayer';
import { LinhVuc, ModelConstant } from '../../../../services/map/SuCo/suco.model';
...
class SearchingComponent extends BaseComponent<Props, State>{
  ...
  componentDidMount(){
    if(this.props.layerSuCo) this.loadDMLinhVuc();
  }
